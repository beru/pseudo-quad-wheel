...
void object_utils_insert(struct PSTATE*,Object *obj, const unichar *key, Value *val,
							   int deletable, int writable, int emuable);
void value_object_utils_insert(struct PSTATE*,Value *target, const unichar *key, Value *val,
							   int deletable, int writable, int emuable);
void object_utils_insert_array(struct PSTATE*,Object *obj, int key, Value *val,
							   int deletable, int writable, int emuable);
void value_object_utils_insert_array(struct PSTATE*,Value *target, int key, Value *val,
							   int deletable, int writable, int emuable);
