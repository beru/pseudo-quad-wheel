...
// Object constructor
static
int Object_constructor(PState* ps, Value* args, Value* _this, Value* ret, int asc)
{
	if (asc) {
...
static
int Function_prototype_constructor(PState* ps, Value* args, Value* _this, Value* ret, int asc)
{
	return 0;
}

static
int Function_constructor(PState* ps, Value* args, Value* _this, Value* ret, int asc)
{
	if (asc) {
...
static
void value_array_shift(PState* ps, Value* v)
{
	if (v->vt != VT_OBJECT) {
...
void fcall_shared_arguments(PState* ps, Value* args, strs* argnames)
{
	if (!argnames) {
		return;
	}
...
void fcall_set_callee(PState* ps, Value* args, Value* tocall)
{
...
static
int Function_prototype_call(PState* ps, Value* args, Value* _this, Value* ret, int asc)
{
	if (asc) {
...
static
int Function_prototype_apply(PState* ps, Value* args, Value* _this, Value* ret, int asc)
{
	if (asc) {
...
static
int String_constructor(PState* ps, Value* args, Value* _this, Value* ret, int asc)
{
	if (asc) {
...
static
int String_fromCharCode(PState* ps, Value* args, Value* _this, Value* ret, int asc)
{
	UNISTR (4096) unibuf;
	if (asc) {
...
static
int Number_constructor(PState* ps, Value* args, Value* _this, Value* ret, int asc)
{
	if (asc) {
		double nv = 0.0;
		if (value_get_length(args) > 0) {
...
static
int Array_constructor(PState* ps, Value* args, Value* _this, Value* ret, int asc)
{
	Value* target;
...
static
int Boolean_constructor(PState* ps, Value* args, Value* _this, Value* ret, int asc)
{
	if (asc) {
		int nv = 0;
		if (value_get_length(args) > 0) {
...
static
int RegExp_constructor(PState* ps, Value* args, Value* _this, Value* ret, int asc)
{
	Value* target;
	if (asc) {
		target = _this;
