...
{
	value_object_utils_insert (ps, global, tounichars (ps, "exit"), func_utils_make_func_value (ps, global_exit), 0, 0, 0);

	/* for testing */
	value_object_utils_insert (ps, global, tounichars (ps, "print"), func_utils_make_func_value (ps, global_print), 0, 0, 0);
	value_object_utils_insert (ps, global, tounichars (ps, "gc"), func_utils_make_func_value (ps, global_gc), 0, 0, 0);
}
